...
└── build_corpus.py, launch_single_node.sh, plotting + provenance helpers
tests/            57 test modules; CPU-runnable, repop required for some
```
...
verifier, and audit-kit provenance. Tests that exercise the
